...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-optimr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8846&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-optimr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-optimr` can be installed with:

```
conda install r-optimr
```

It is possible to list all of the versions of `r-optimr` available on your platform with:
